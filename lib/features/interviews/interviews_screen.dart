    ...
    try {
      ...
      timer = Timer.periodic(const Duration(seconds: 1), (t) {
        ...
        if (t.tick % 10 == 0 && audio.length > 0)
          save(interviewWav(audio.toBytes()), metadata!, false)
              .catchError((Object e) {
    ...
    return PopScope(
        ...
        child: Scaffold(
            body: ListView(
                ...
                children: [
              const Text('Qualitative interviews',
              ...
              StreamBuilder<List<InterviewDraft>>(
                  stream: (db.select(db.interviewDrafts)
                          ...
                          child: ListTile(
                              ...
                              trailing: Wrap(children: [
                                ...
                                if (!d.ready && !recording)
                                  TextButton(
                                      onPressed: () async {
                                        await (db.update(db.interviewDrafts)
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ...
                                    Wrap(spacing: 10, children: [
                                      TextButton.icon(
                                          icon: Icon(playingId == row['id']
                                              ? Icons.stop
                                              : Icons.play_arrow),
                                          label: Text(playingId == row['id']
                                              ? 'Stop'
                                              : 'Play recording'),
                                          onPressed: () async {
                                            try {
