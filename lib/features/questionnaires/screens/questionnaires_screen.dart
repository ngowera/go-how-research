...
class _QuestionnairesScreenState extends ConsumerState<QuestionnairesScreen> {
              ...
              children: [
                isPhone
                    ...
                    : Row(
                        ...
                        children: [
                          _buildHeading(),
                          if (!_collectionMode) _buildNewQuestionnaireButton(),
                        ],
                      ),
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          _workspaceTab(
                              true, Icons.edit_note_rounded, 'Collect Data'),
                        ],
                      ),
                    )),
                          ...
                          : questionnaires.isEmpty
                              ...
                              : ListView.separated(
                                  ...
                                  itemBuilder: (context, idx) {
                                    ...
                                    final projTitle =
                                        projectsMap[q.projectId] ??
                                            'Unassigned Project';

                                    return LayoutBuilder(
                                      builder: (context, itemConstraints) {
                                        final compact =
                                            itemConstraints.maxWidth < 600;
                                        return Container(
  ...
  Widget _buildHeading() => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Questionnaires & Data Collection',
              style: GoogleFonts.poppins(
                  fontSize: 26,
  ...
  Widget _buildNewQuestionnaireButton() => ElevatedButton.icon(
  ...
  Widget _questionnaireTitle(dynamic q, String projectTitle) => Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(q.title,
              maxLines: 2,
              ...
              style: GoogleFonts.poppins(
                  ...
                  color: const Color(0xFF1E293B))),
          const SizedBox(height: 4),
          Text('Project: $projectTitle • Version ${q.version}',
              maxLines: 2,
              overflow: TextOverflow.ellipsis,
              style: GoogleFonts.poppins(
  ...
  List<Widget> _questionnaireActions(dynamic q) => [
        Container(
          padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
          decoration: BoxDecoration(
              color:
                  q.isApproved ? Colors.green.shade50 : Colors.orange.shade50,
              borderRadius: BorderRadius.circular(6),
              border: Border.all(
                  color: q.isApproved
                      ? Colors.green.shade300
                      : Colors.orange.shade300)),
          child: Text(q.isApproved ? 'APPROVED' : 'DRAFT / PENDING',
              style: GoogleFonts.poppins(
                  fontSize: 11,
                  fontWeight: FontWeight.w600,
                  color: q.isApproved
        ...
        OutlinedButton.icon(
            onPressed: () => _collectionMode
                ...
                : showDialog(
                    context: context,
                    builder: (_) => QuestionnaireShareDialog(questionnaire: q)),
            icon: const Icon(Icons.play_circle_outline_rounded, size: 16),
            label:
                Text(_collectionMode ? 'Start Collection' : 'Collect / Share')),
        if (!_collectionMode)
          ElevatedButton.icon(
              onPressed: () => context.go('/questionnaires/${q.id}/builder'),
